...
public class MoveShape {
    ...
    public static void moveShape(Scanner sc, List<AbstractShape> shapeList) {
        ...
        try {
            ...
            if (choice >= 1 && choice <= movableShapes.size()) {
     ...
     */
    private static List<AbstractShape> getMovableShapes(List<AbstractShape> shapeList) {
     ...
     */
    private static int getShapeChoice(Scanner sc, int maxChoice) {
        while (true) {
            try {
