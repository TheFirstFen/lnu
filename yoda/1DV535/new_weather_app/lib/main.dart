...
import 'package:new_weather_app/weather_provider.dart';

const Color kBackgroundColor = Color.fromARGB(255, 243, 219, 219);
  ...
  Future<void> _fetchLocationAndWeather() async {
    try {
      ...
      if (placemarks.isEmpty) {
        throw Exception('Unable to get placemarks');
      }
