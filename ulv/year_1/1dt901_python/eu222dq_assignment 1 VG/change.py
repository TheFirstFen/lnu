# Price,
price = float(input("Enter the prize: "))
# payment
payment = float(input("Enter the payment: "))
# Money to be returned
cash = round(payment - price)
# amount of hole 1000kr bills

cash_1000 = (cash//1000)
# amount left after the 1000kr bills
cash1 = cash % 1000

# Same as above but with different values on bills and coins.
cash_500 = (cash1 // 500)
cash2 = cash1 % 500
...
# printing what bill and then the amount of that bill
print("1000kr bills: {}".format(cash_1000))
