...
func CreateStudent(w http.ResponseWriter, r *http.Request) {
    ...
    result, err := db.Exec("INSERT INTO student (name, age, grade) VALUES (?, ?, ?)", student.Name, student.Age, student.Grade)
    if err != nil {
...
func GetStudent(w http.ResponseWriter, r *http.Request) {
    ...
    var student Student
    err := db.QueryRow("SELECT studentid, name, age, grade FROM student WHERE studentid = ?", id).Scan(&student.ID, &student.Name, &student.Age, &student.Grade)
    if err != nil {
...
func UpdateStudent(w http.ResponseWriter, r *http.Request) {
    ...
    _, err = db.Exec("UPDATE student SET name = ?, age = ?, grade = ? WHERE studentid = ?", student.Name, student.Age, student.Grade, id)
    if err != nil {
        http.Error(w, err.Error(), http.StatusInternalServerError)
        return
    }
...
func DeleteStudent(w http.ResponseWriter, r *http.Request) {
    ...
    _, err := db.Exec("DELETE FROM student WHERE studentid = ?", id)
    if err != nil {
        http.Error(w, err.Error(), http.StatusInternalServerError)
        return
    }
