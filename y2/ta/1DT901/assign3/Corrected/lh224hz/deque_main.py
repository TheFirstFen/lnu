...
# Program starts
empty = Deque()     # An empty deque
deque = Deque()     # To be filled
...
print("get_last() on an empty deque:", empty.get_last())

# Test get_first
print("\nget_first():", deque.get_first())
print("get_first() on an empty deque:", empty.get_first())

# Test remove_first
print("\nremove_first():", deque.remove_first())
print("remove_first() on an empty deque:", empty.remove_first())

# Test remove_last
print("\nremove_last():", deque.remove_last())
print("remove_last() on an empty deque:", empty.remove_last())
