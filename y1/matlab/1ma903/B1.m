...
n=2902;                        % Antal delintervall/number of subintervals
...
disp(['U-L=' num2str(U-L)]);
disp(['L-U=' num2str(abs(L-U))]);
disp(['(U+L)/2=' num2str((U+L)/2)]); % ger att 2902 som exakt n för L-U <= 0.01